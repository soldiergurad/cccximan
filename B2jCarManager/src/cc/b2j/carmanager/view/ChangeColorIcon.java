package cc.b2j.carmanager.view;
...
public class ChangeColorIcon extends View
{
			...
			int defStyleAttr)
	{
		...
		for (int i = 0; i < n; i++)
		{
			...
			switch (attr)
			{
			case R.styleable.ChangeColorIcon_buer_icon:
				BitmapDrawable drawable = (BitmapDrawable) a.getDrawable(attr);
				mIconBitmap = drawable.getBitmap();
				break;
			case R.styleable.ChangeColorIcon_buer_color:
				mColor = a.getColor(attr, 0xFF45C01A);
				break;
			case R.styleable.ChangeColorIcon_buer_text:
				mText = a.getString(attr);
				break;
			case R.styleable.ChangeColorIcon_buer_text_size:
